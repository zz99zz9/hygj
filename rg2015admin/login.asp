					...
					<form name="Form1" action="Login.Asp" method="post" onsubmit="return checkform();">
						<fieldset>
							...
							<div class="input-prepend" title="Password" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="UserPass" id="UserPass" type="password" />
							</div>
							<div class="clearfix"></div>
							<div class="clearfix"></div>

							<p class="center span5">
							<button type="submit" class="btn btn-primary">登 录</button><Input type="hidden" name="Action" value="Login" />
							</p>
						</fieldset>
					</form>
				</div><!--/span-->
