...
<!--#include file="leftmenu.asp"-->
  ...
  <form method="POST" name="form1" onSubmit="return CheckForm();" action="?action=Save" >
    <tr>
      <td height="30" colspan="2" align="center" class="xingmu"><strong>添 加 产 品</strong></td>
    </tr>
    <tr>
...
<textarea name="content" style="width:100%;height:450px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>      </td>
    </tr>
