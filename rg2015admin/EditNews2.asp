...
news.close
set news=nothing
response.write "<script language='javascript'>alert('提交成功');javascript:ToUrl('news2.asp?yt="&newskinds&"');</script>"
else
...
<!--	
	...
	-->
    <tr class="hback">
      <td width="98" height="30" align="right" class="back"><%=rs("newskinds")%>链接： </td>
