...
oRs.UPdate
%>
<title><%=oRs("Newstitle")%>-<%=siteTitle%></title>
...
<div id="mainBg">
 ...
 <div id="content" class="clearfix">
        <p class="crumbs"><a href="http://www.huayuanguanjia.com">首页</a><span> <em>&gt;</em> </span><a href="story.asp">花园故事</a> <em>&gt;</em> <span>详情页</span></span></p>
            <div class="leftContent">
              <div class="clearfix mgt10 detail">

                       
                       <h3><%=oRs("Newstitle")%></h3>
                          <div class="content imgcenter" style="margin:0px auto;width:800px;"><%=oRs("newstext")%></div>
