...
#ma2{background:#FFF;text-align:center;width:90%;margin:0px auto 10px auto;}
#ma2 img{width:95%;margin:0px auto 10px auto;}
#mab{height:25px;}
</style>
<!--菜单-->
...
sql="select * from news where newskinds='花园故事' and newsid="&id&" order by orderid,NEwsId desc"
rs.open sql,conn,3,3
if rs.eof then
else

do while not rs.eof%>
<div id="ma2"><br /><%=rs("newstitle")%><br /><br /><%=rs("newstext")%></div>
