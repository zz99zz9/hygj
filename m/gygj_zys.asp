...
<a href="gygj_zys_View.asp?id=<%=rs("Prod_id")%>"><div id="ma"><div id="ma1"><img src="../<%=rs("prod_pic")%>" /></div><div id="ma2"><h1><%=rs("prod_name")%></h1><span>[ <%=rs("kid_name")%> ]</span><br /><%=left(rs("prod_gw"),25)%>……</div><div class="clear"></div></div></a>
