...
set rs=server.CreateObject("adodb.recordset")
		...
		rs.close
		set rs=nothing		
		response.Write"<meta http-equiv='refresh' content='2;URL=http://www.huayuanguanjia.com/m/gygj_hygs.asp'><center><p style='margin:20px;margin-top:50px;line-height:50px;font-size:25px;'>预约成功，我们会尽快和您联系！现在去看看我们的花园作品吧!</p><a href='gygj_hygs.asp' style='font-weight:bold;font-size:25px;'>立即跳转</a></center>"		
else
%>
