...
<div id="content" class="clearfix">
      <div class="contentList"> 
        <div class="caseList clearfix mgt10 case">
          <h2>我要学<strong>I want to learn</strong></h2>
...
do while not rs.eof and count<rs.PageSize %>
              ...
              <div class="item_t">
                <div class="img"><a href="StudyView.asp?id=<%=rs("newsid")%>&Action=<%=Rs("NewsKinds")%>"><img width="230" alt="<%=GotToPic(rs("newstitle"),60)%>" src="<%=rs("newspic")%>" alt="<%=rs("newstitle")%>"/></a></div>
                <div class="title">
                  <h3 style="line-height:180%;"><a href="StudyView.asp?id=<%=rs("newsid")%>&Action=<%=Rs("NewsKinds")%>"><%=GotToPic(rs("newstitle"),50)%></a></h3>
