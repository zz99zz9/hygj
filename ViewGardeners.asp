...
<div id="mainBg">
 ...
 <div id="content" class="clearfix">
        <p class="crumbs"><a href="http://www.huayuanguanjia.com">首页</a><span> <em>&gt;</em> </span><a href="Gardeners.asp">造园师</a> <em>&gt;</em> <span><%=oRs("Prod_name")%></span></span></p>
            <div class="leftContent">
              <div class="clearfix mgt10 detail">

                       

                          <div class="content imgcenter" style="margin:0px auto;width:950px;"><div class="zysleft"><img src="<%=oRs("Prod_pic")%>" style="height:180px;width:150px;"/><br /><span class="t"><%=oRs("Prod_name")%></span><br />性别：<%if oRs("Prod_xb")=2 then%>女士<%else%>先生<%end if%><br />等级：<%=ors("kid_name")%><br /></div>
                           <div style="width:750px;float:right;border-left:1px #CCCCCC dashed;padding-left:10px;min-height:500px;">感悟：<%=oRs("Prod_gw")%><br />经历：<%=oRs("Prod_jl")%><br />荣誉：<%=oRs("Prod_ry")%><br />作品：</div>
