...
{
	var unit_id     = "3395498";
	var client_ip   = "203.192.147.166";
	var server_time = "1400317505";
	var verify_code = "ccb57cf7";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/3395498/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
